...
def home():
    ...
    return (
        ...
        f"<h2><a href='https://cebulada.github.io/Great_Lakes_ML/index.html' target='_blank'>Link</a> to Web Visualizations hosted on Github Pages</h2>"
        ...
        f"<p>Need at minimum mod0 to receive a prediction.  The following list are all the parameters and what they correspond to.  All numeric values are float64(accepts decimal values):</p>"
        f"""<ol>
